      ...
      <footer class=" border-t bg-gray-900 border-gray-600 text-center lg:text-left text-gray-500 ">
        ...
        <div class="mx-6 py-10 text-center md:text-left ">
          ...
          ">
              ...
              <p>
                We are Lucknow based elevator control panel manufacture and whole electrical kit supplier. Successfully delivering elevator control panels north India since 2017. Our UPS are our product quality with solution support. We tend to keep our products easy to install and provide higher safety measures in our products.
              </p>
            </div>
            <div class="">
              ...
              <p class="mb-4">
                <a href="#!" class="text-gray-600">Product1</a>
              </p>
              <p class="mb-4">
                <a href="#!" class="text-gray-600">Product2</a>
              </p>
              <p class="mb-4">
                <a href="#!" class="text-gray-600">Product3</a>
              </p>
              <p>
                <a href="#!" class="text-gray-600">Product4</a>
              </p>
            </div>
            <div class="">
              <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
