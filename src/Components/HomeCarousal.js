    ...
    <div className='max-w-[1400px] h-screen w-full m-auto mb-5 relative group'>
      ...
      <div className='w-full h-full bg-center bg-blue-700 flex'>
        <div className='w-2/5 h-full relative justify-center items-center'>
          <div className='absolute text-white text-opacity-10 -z-1 font-bold text-8xl top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-3/4'>{slides[currentIndex].title}</div>
          <div className='p-20 flex-col items-center justify-evenly'>
            <div className='text-sky-500 font-bold text-6xl mb-9 z-10'>{slides[currentIndex].title}</div>
        ...
        <div className='w-3/5 p-30 h-full'>
          <div className='p-30 h-full relative'>
            <div className='absolute w-3/4 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
              <img className='object-contain' src={CardImage} alt='card decor png image'></img>
            </div>

            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
              <img className='object-contain' src={slides[currentIndex].url} alt='card decor png image'></img>
            </div>
          </div>
